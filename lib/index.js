...
class RentalWorks {
    ...
    getQuoteItems(quoteId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let page = 1;
            let totalPages = 1;
            let data = { Rows: [], TotalRows: 0, TotalPages: 0 };
            do {
                let payload = {
                    "miscfields": {
                        "QuoteId": {
    ...
    addSingleItemToOrderBottom(orderId, item, belowItemId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let req = yield axios_1.default.post(`${this.baseURL}/api/v1/orderitem`, Object.assign(Object.assign({}, item), { OrderId: orderId }), {
                    headers
                });
                return req.data;
            }
